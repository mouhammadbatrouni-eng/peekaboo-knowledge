# Peekaboo Portal — Complete Staff Guide

Everything in the portal: what each page is, what every word means, how to add,
edit, delete and find things, and what the portal does not do.

**Portal:** https://peek.peek-a-boo.app

## How to read this guide

Every screen name, button, tab and field in **bold** was checked against the
version of the portal your nursery actually runs. Where you see this marker:

> **Not yet checked on a live system:** ...

it means that detail is expected but has not been confirmed by using the portal.
Treat those lines as guidance rather than fact, and tell us if one is wrong.

Anything not covered here, the assistant should say it does not know rather than
guess.
...
<!-- ========== 01-pages-and-navigation ========== -->

# Peekaboo Portal — Pages and Where to Find Them

Your portal lives at **https://peek.peek-a-boo.app**

Before you start, one thing that explains a lot of confusion: **the menu down the side only shows the pages your role is allowed to open.** Two colleagues sitting next to each other will see different menus, and neither of them is wrong. If a workmate describes a page you cannot see, it is almost always because their role has access to it and yours does not, rather than anything being missing from your screen.

A **Principal** sees every page. Everyone else sees only what has been switched on for their role.

The menu is organised into nine groups. This guide walks through them in the order they appear.
...
### Centers
**https://peek.peek-a-boo.app/app/centers**

The master list of every center on the platform, each with its own administrator account. The table shows **Center**, **Contact**, **Currency**, **Capacity**, **Phone**, **Admin** and **Actions**. The center record itself is organised into sections covering **Center details**, **Contacts**, **Social media**, **Address & regional settings**, **Center logo**, **Financial**, and **License & center administrator**.

**Who can open it:** Principal only. This page is reserved for the Principal role and cannot be granted to anyone else.

### My Center
**https://peek.peek-a-boo.app/app/my-center**

Your own center's details, for viewing and updating. It is arranged into **Contacts**, **Social Media**, **Address**, **Financial** and **Map** sections, plus a **Center Logo**. This page also holds your center's daily sessions, listed as **Session Name**, **From Time**, **To Time** and **Status**.

**Who can open it:** anyone whose role has the **My Center** permission, plus the Principal.

### Packages
**https://peek.peek-a-boo.app/app/packages**

Your center's subscription. It shows your current plan with a **Valid until** date, a **Children limit** and **Package units**, and lets you choose a different package. Purchasing asks for a **Start date**, a **Number of months** and card details, with an **Order summary** showing **Children capacity**, **Subscription period**, **End date** and **Total**. Card payments are handled by Stripe.

**Who can open it:** anyone whose role has the **Packages** permission, plus the Principal.
...
### Live Dashboard
**https://peek.peek-a-boo.app/app**

The landing page when you sign in. It has three tabs: **Main Dashboard**, **Finance** and **CRM**.

**Main Dashboard** covers **Active Staff** and **Classroom Occupancy**. **Finance** covers **Total Invoiced**, **Outstanding Fees**, **Total Collected**, a **Financial Snapshot**, **Pending Payments**, **Expenses**, **Bills vs Collected**, **Revenue by Age Group** and **Outstanding Balances**. **CRM** covers **Total Leads**, **New Leads**, **Tour Booked**, **Toured**, **Waiting List**, **Approved**, **Lost** and **Rejected**, with charts for **Leads**, **Referrals Type**, **Source** and **Referrals**.

**Who can open it:** anyone whose role has the **Dashboard** or **Home** permission, plus the Principal.

### Children Attendance
**https://peek.peek-a-boo.app/app/attendance**

The check-in and check-out board for children. It shows counts for **Present**, **Absent**, **Late** and **Excused**, and a table with **Child**, **Classroom**, **Status**, **Check-In**, **Check-Out**, **Allergy** and **Actions**.

This page works on **today's date**. It loads today's attendance and saves against today.

**Who can open it:** anyone whose role has the **Daily Report** permission, plus the Principal.

### Staff Attendance
**https://peek.peek-a-boo.app/app/staff-attendance**

The same idea for your team. Staff attendance uses **Present**, **Late**, **Absent**, **On Leave** and **Not Marked**, and records a **Check / Checkout**. Staff are shown with their **Role**.

**Who can open it:** anyone whose role has the **Daily Report** permission, plus the Principal.

### Daily Reports
**https://peek.peek-a-boo.app/app/daily-reports**

The parent-facing daily report for each child. A report can carry the child's mood, **Meals** (**Breakfast**, **Snack AM**, **Lunch**, **Snack PM**, **Milk**), **Nap** with a **From** and **To**, daily care items (**Water**, **Juice**, **Medicine**, **Hygiene**), a temperature, **Activities & behaviour**, a **Note to parents**, **Photos**, and **Items Needed** (**Diapers**, **Clothes**, **Wipes**, **Cream**).

Reports appear as either **Published** or **Draft**. There is a **Publish & Email** option and a **Print / PDF** option.

Which of these sections parents actually see is controlled per class over on the **Classes** page.

**Who can open it:** anyone whose role has the **Daily Report** permission, plus the Principal.

### Calendar
**https://peek.peek-a-boo.app/app/calendar**

Nursery-wide events, holidays and key dates, viewable by **Month** or as an **Agenda**. An event carries an **Event title**, **Event type**, **Start date**, **End date**, **Start time**, **End time**, **Location**, **Audience**, an **All day event** option, a **Description**, and **Branches**. Leaving branches unselected makes the event nursery-wide.

**Who can open it:** anyone whose role has the **Communication** or **Console** permission, plus the Principal.
...
### Children
**https://peek.peek-a-boo.app/app/children**

Your register of children. The page shows how many are **enrolled**, how many are **with allergies** and how many are **with medical conditions**. You can search by name or ID and filter by campus, class, age group and status. Children are marked **Active** or **Inactive**.

**Who can open it:** anyone whose role has the **Our Loved Ones** permission, plus the Principal.

### Staff
**https://peek.peek-a-boo.app/app/staff**

Your team records, available as a **Card view** or a **Table view**. The table columns are **Employee Name**, **Picture**, **Role**, **Username**, **Password**, **Email** and **Phone**. A staff record holds contact details, **Nationality**, **DOB**, address, login details, **Role**, **Emergency Contact Name** and **Emergency Contact Number**, **Capabilities**, **Joining Date**, **Employee Last Day**, **Employee Note**, **Social Security**, **Degree** and **Diploma**. Staff are **Active** or **Inactive**, with **Activate** and **Deactivate** options.

The list can be exported using **Copy**, **PDF**, **Print** and **CSV**.

**Who can open it:** anyone whose role has the **Our Heroes** permission, plus the Principal.
...
### Messages
**https://peek.peek-a-boo.app/app/messages**

Where you send information out to families. It is split by type: **Announcement**, **Notification**, **Event**, **Newsletter**, **Media** and **Video Media**. You choose the audience by selecting classes or individual children, and a message can carry a **Title**, a **URL**, a **Start Date / Time** and **End Date / Time**, a **Timezone**, a **Description**, an **Icon** and an **Attachment**. There is a **Pin to Top** option and a **Publish Now** option.

Everything you have sent is kept in a **History** table with columns for **Type**, **Title**, **Pinned**, **Publish On**, **Published** and **Created On**.
...
Your classroom records, as a **Table view** or **Card view**. A class has a **Class Name**, **Class Description**, **Age Group**, **No. of Children**, **Teacher Ratio**, a **Status** of **Active** or **Inactive**, a **Class Online URL** and a **Class Logo**, and you assign teachers to it here.

This page also holds **Parent report visibility** — the switches that decide which parts of the daily report families see for this class, grouped into **Daily Care**, **Breakfast**, **Snack 1**, **Lunch**, **Snack 2**, **Milk** and **Health Tracking**.

**Who can open it:** anyone whose role has the **Classes** permission, plus the Principal.

### Curriculum
**https://peek.peek-a-boo.app/app/early-childhood/curriculum**

Your curriculum records, each with a **Curriculum Name** and an image preview. Curriculum is the top of the early years structure: age groups, learning areas and attainment levels all attach to one.

**Who can open it:** anyone whose role has the **Curriculum** permission, plus the Principal.

### Age Groups
**https://peek.peek-a-boo.app/app/early-childhood/age-groups**

The age bands used across the portal, each belonging to a **Curriculum**. Age groups are used by classes, and the Finance dashboard groups revenue by them.

**Who can open it:** anyone whose role has the **Age Groups** permission, plus the Principal.

### Attainment
**https://peek.peek-a-boo.app/app/early-childhood/attainment**

Your **Attainment Levels** — the scale teachers use when recording how a child is doing against an objective. Each level belongs to a **Curriculum**.

**Who can open it:** anyone whose role has the **Attainment** permission, plus the Principal.

### Learn Area
**https://peek.peek-a-boo.app/app/early-childhood/learning-area**

Learning areas, each with a **Curriculum**, a **Color** and a **Status**. Each learning area contains **Learning Aspects**, and each aspect has an **Aspect** name, a **Description** and an **Enabled** setting.

**Who can open it:** anyone whose role has the **Learn Area** permission, plus the Principal.

### Assessments
**https://peek.peek-a-boo.app/app/early-childhood/assessment**

The hub for early years assessment. It shows **Total Assessments**, **Children Assessed** and **Total Comments**, and links onward to **Open Observations** and **Open Assessment Report**.

**Who can open it:** anyone whose role has the **Assessments** permission, plus the Principal.

### Observations
**https://peek.peek-a-boo.app/app/early-childhood/observation**

Sits underneath Assessments. This is where a teacher records what they noticed about a child. An observation has a **Class**, a **Teacher**, a **Child**, a **Date**, an **Observation Title**, **Notes**, the **Observation** itself, a **Next Step**, and a set of selected objectives each given an attainment level.

Everything recorded appears under **Saved Observations**, with columns **Observation**, **Child**, **Class**, **Date**, **Objectives** and **Actions**.

**Who can open it:** anyone whose role has the **Observations** permission, plus the Principal.

### Assessment Report
**https://peek.peek-a-boo.app/app/early-childhood/assessment-report**

Also sits underneath Assessments. You choose a **From Date**, a **To Date** and a **Class**, and generate a report built from the observations recorded in that window. Results appear with **Child Name**, **Area** and **Comments**, and you can add and save comments against them.

Reports can be exported with **Copy**, **PDF**, **Print** and **CSV**.

**Who can open it:** anyone whose role has the **Assessment Report** permission, plus the Principal.
...
### Suppliers
**https://peek.peek-a-boo.app/app/suppliers**

The businesses you buy from. Columns are **Supplier Name**, **Phone**, **Email** and **VAT**. A supplier record also holds a **Supplier Address**, **Supplier Terms** and a **Supplier Description**.

**Who can open it:** anyone whose role has the **Suppliers** permission, plus the Principal.

### Expenses
**https://peek.peek-a-boo.app/app/expenses**

Money going out. Columns are **Date**, **Supply**, **Supplier**, **Amount**, **Attachment**, **VAT** and **Description**. Each expense can carry a file attachment, and attachments are limited to 2 MB.

Expenses can be exported with **Copy**, **PDF**, **Print** and **CSV**.

**Who can open it:** anyone whose role has the **Expenses** permission, plus the Principal.

### Expense Types
**https://peek.peek-a-boo.app/app/expense-types**

The categories your expenses are filed under, each with a **Type Name** and a **Description**.

**Who can open it:** anyone whose role has the **Expense Types** permission, plus the Principal.

### Payment Voucher
**https://peek.peek-a-boo.app/app/payment-voucher**

Records of payments made out to suppliers. Columns are **Date**, **Type**, **Number**, **Supplier** and **Amount**. A voucher carries one or more payment lines, each with a **Value Date**, a **Mode** and an **Amount**.

**Who can open it:** anyone whose role has the **Payment Voucher** permission, plus the Principal.

### Purchases
**https://peek.peek-a-boo.app/app/purchases**

What you have bought in. Columns are **Date**, **Type**, **Purchase#**, **Supplier** and **Amount**. Each purchase line takes a **Service**, a **QTY** and a **Fee**.

**Who can open it:** anyone whose role has the **Purchases** permission, plus the Principal.
...
### Services
**https://peek.peek-a-boo.app/app/services**

The things you charge for — this is the price list that invoices draw from. Columns are **Service Name**, **Service Fee**, **Service Type**, **Service VAT**, **Service Cost** and **Tax Exempt**. A service also has a **Services Description** and a **Services MOQ**.

**Who can open it:** anyone whose role has the **Services** permission, plus the Principal.

### Receipts
**https://peek.peek-a-boo.app/app/receipts**

Money coming in from families. Columns are **Date**, **Child Name**, **Type** and **Amount**. A receipt carries **Payment Lines**, each with a **Value Date**, a **Mode of Payment**, a **Payment Detail** and an **Amount**. Receipts can be printed and emailed to the child's parent.

**Who can open it:** anyone whose role has the **Receipts** permission, plus the Principal.

### Invoices
**https://peek.peek-a-boo.app/app/invoices**

What you bill families. Columns are **Date**, **Inv#**, **Amnt** and **Child**. An invoice is built from lines drawn from your Services list, each with a **QTY**, a **Fee**, a **Disc%**, a **VAT%** and a **Total**, and the invoice carries a **Tax Exempt** option. Invoices can be printed and emailed to the child's parent.

**Who can open it:** anyone whose role has the **Invoices** permission, plus the Principal.

### Payment Modes
**https://peek.peek-a-boo.app/app/payment-modes**

The ways your center accepts money, used by receipts and payment vouchers. Columns are **Acc#**, **Desc** and **Chart ID**.

**Who can open it:** anyone whose role has the **Payment Modes** permission, plus the Principal.

### Balance by Class
**https://peek.peek-a-boo.app/app/balance-by-class**

What each family still owes, arranged by class. Columns are **Student**, **Billed**, **Received** and **Balance**, shown **As of** a date. You can search for a particular student.

**Who can open it:** anyone whose role has the **Balance by Class**, **Invoices** or **Receipts** permission, plus the Principal.
...
### Attendance Reports
**https://peek.peek-a-boo.app/app/attendance-reports**

Attendance history for both children and staff, with separate **Children** and **Staff** views. You set a **From** and **To** date and can narrow by **Classroom** or **Role**.

Each row totals **Total Working Days**, **Total Present Days**, **Total Late Days**, **Total Absent Days** and **Total Not Marked Days**, with **Present %**, **Absent %** and **Not Marked %**.

Reports can be exported as **CSV** or **Print / PDF**.

**Who can open it:** anyone whose role has the **Daily Report** permission, plus the Principal.

### Roles & Access
**https://peek.peek-a-boo.app/app/roles**

Where roles are created and their access is set. Roles are listed with a **Role name** and a **Status** of **Active** or **Inactive**. **Manage access** opens the **Access assignment** panel, where you tick the modules a role may reach, with **Select all** and **Clear all** to help.

This is the page that decides what everybody else's menu looks like.

**Who can open it:** the Admin role, plus the Principal. Other roles cannot reach it even if given the permission.
...
### CRM Leads
**https://peek.peek-a-boo.app/app/crm/leads**

Your enquiry pipeline. Columns are **Student Name**, **Parent Name**, **Phone**, **Email** and **Grade**, and each lead carries details including **Term**, **DOB**, **Age**, **Nationality**, **Operator**, **Expected Joining**, **Source**, **Referral**, **Previous School** and **Inquiry Date**.

Against a lead you can keep **Notes** and **Tasks**, move the lead to a different status, and send email to the parent. There is an **Email Templates** area holding a template per lead status.

Leads progress through stages — the full list, and an important note about stage names, is in *Words and Statuses*.

**Who can open it:** anyone whose role has the **CRM**, **Leads** or **Admissions** permission, plus the Principal.

### Referrals & Sources
**https://peek.peek-a-boo.app/app/crm/referrals-sources**

The lookup lists behind the CRM, split into **Referrals** and **Communication Sources**. Referrals are typed as **Digital**, **Printed**, **Signs**, **Recommendation**, **Event** or **Others**. Communication sources are grouped as **General**, **Admission** or **Communication**.
...
There are eight roles: **No Role**, **Principal**, **Registrar**, **Teacher**, **Assistant**, **Accountant**, **Admin** and **Guest**.

**Principal** reaches everything. **Admin** is the only role besides Principal that can open **Roles & Access** and **Referrals & Sources**. **Centers** is Principal-only. Every other role sees exactly the pages ticked for it on the **Roles & Access** page.

---

**How current is this?**

This describes the Peekaboo portal as at the current release. It covers what pages exist, what each one is for, and who can open them. It deliberately does not include step-by-step instructions for completing tasks — those are being verified separately and will follow.


---


<!-- ========== 02-words-and-statuses ========== -->

# Peekaboo Portal — Words and Statuses

Peekaboo uses particular words for particular things, and staff often say something different in conversation. This page connects the two, then lists every status you will meet on screen and what it means.
...
**Our Loved Ones**
Peekaboo's own name for the children in your care. You will see it as a permission name on the **Roles & Access** page. The menu item itself is simply **Children**.
*You might also say:* children, kids, students, pupils, little ones.

**Our Heroes**
Peekaboo's own name for your team. Like the above, it appears as a permission name on **Roles & Access**, while the menu item reads **Staff**.
*You might also say:* staff, team, employees, teachers.

**Child**
One child's record, holding their details, allergies and medical information. Children are **Active** or **Inactive**.
*You might also say:* student, pupil, kid.

**Staff Member** / **Employee**
One person on your team. Their record holds contact details, a login, a **Role**, emergency contacts and employment dates. The portal uses **Employee Name** on forms and **Staff Member** on the attendance board.
*You might also say:* teacher, colleague, employee, team member.

**Parent**
The family contact attached to a child. Invoices and receipts are emailed to the parent, and daily reports are published to them.
*You might also say:* family, guardian, mum, dad, carer.

**Role**
The job type attached to a login, which decides what that person can see. The eight roles are **No Role**, **Principal**, **Registrar**, **Teacher**, **Assistant**, **Accountant**, **Admin** and **Guest**.
*You might also say:* permission level, access, job title.

**Lead**
An enquiry from a family who might join. Leads live on the **CRM Leads** page and move through stages.
*You might also say:* enquiry, inquiry, applicant, prospect, waiting list family.

### Places and groupings

**Center**
Your nursery setting. Most staff only ever deal with one, managed on the **My Center** page.
*You might also say:* nursery, setting, branch, site, campus, school.

**Class**
A classroom group, with an age group, a child count and a teacher ratio. Classes are set up under **Early Childhood**.
*You might also say:* classroom, room, group.

**Age Group**
An age band attached to a curriculum. Classes belong to one, and the Finance dashboard groups revenue by them.
*You might also say:* age band, age range.

### Early years

**Curriculum**
The top of the early years structure. Age groups, learning areas and attainment levels each belong to a curriculum.
*You might also say:* framework, EYFS, programme.

**Learn Area**
A broad area of learning, each with its own colour. Inside each one sit **Learning Aspects**.
*You might also say:* learning area, area of learning, domain.

**Aspect**
A subdivision of a learning area, with a description and an enabled setting.
*You might also say:* sub-area, strand.

**Attainment**
The scale used to record how a child is doing against an objective. Levels are set up per curriculum.
*You might also say:* level, grade, achievement, progress rating.

**Observation**
A record of what a teacher noticed about a child, tied to a class, a date, selected objectives and a **Next Step**.
*You might also say:* note, learning journal entry, assessment note.

**Next Step**
What the teacher plans to do next for that child, recorded on the observation.
*You might also say:* follow-up, target, plan.

**Assessment Report**
A report generated from observations over a date range for a class.
*You might also say:* progress report, learning journal, summary.

### Daily practice

**Attendance**
The check-in and check-out record. Children and staff have separate pages.
*You might also say:* register, sign-in, roll call.

**Check-In** / **Check-Out**
The times a child or staff member arrived and left.
*You might also say:* drop-off and pick-up, in and out, clocking in.

**Daily Report**
The record sent home to parents about a child's day, covering meals, nap, care, activities and photos.
*You might also say:* daily sheet, parent report, day sheet, journal.

**Items Needed**
The supplies a family should send in: **Diapers**, **Clothes**, **Wipes**, **Cream**.
*You might also say:* supplies needed, please bring.

### Money

**Service**
Something you charge for, with a fee and a VAT rate. Services are the price list invoices are built from.
*You might also say:* fee, charge, item, tuition.

**Invoice**
A bill raised against a child, built from service lines.
*You might also say:* bill, statement, fee note, charge.

**Receipt**
A record of money received from a family, made up of payment lines.
*You might also say:* payment, remittance.

**Payment Mode**
A way your center accepts money, used on receipts and payment vouchers.
*You might also say:* payment method, payment type.

**Expense**
Money going out, categorised by an **Expense Type** and optionally carrying an attachment.
*You might also say:* cost, outgoing, spend, bill to pay.

**Supplier**
A business you buy from.
*You might also say:* vendor, provider, contractor.

**Purchase**
Something bought in from a supplier, recorded as lines with a quantity and fee.
*You might also say:* order, PO, buy.

**Payment Voucher**
A record of a payment made out to a supplier.
*You might also say:* payment out, remittance, cheque.

**Balance**
What a family still owes: **Billed** minus **Received**.
*You might also say:* outstanding, owing, arrears, debt.

**VAT**
The tax rate on a service or expense. A service or invoice can be marked **Tax Exempt**.

**MOQ**
The minimum order quantity on a service, labelled **Services MOQ**.

### Admissions

**Source**
Where an enquiry came from. Maintained on the **Referrals & Sources** page as **Communication Sources**, grouped **General**, **Admission** or **Communication**.
*You might also say:* channel, where they heard about us.

**Referral**
Who or what pointed a family to you, typed as **Digital**, **Printed**, **Signs**, **Recommendation**, **Event** or **Others**.
*You might also say:* recommendation, word of mouth.

**Task**
A follow-up action recorded against a lead, with a date and a reminder date.
*You might also say:* to-do, callback, follow-up.
...
Recorded on **Children Attendance**.

| Label | Meaning |
|---|---|
| **Present** | The child is in today. |
| **Absent** | The child is not in today. |
| **Late** | The child arrived after the expected time. |
| **Excused** | The child is away with prior agreement. |
| **Not Marked** | No attendance has been recorded for this child yet. |

**Not Marked** is what you see before anyone has touched the record, rather than something you choose.

### Staff attendance

Recorded on **Staff Attendance**. The set differs slightly from the children's.

| Label | Meaning |
|---|---|
| **Present** | The staff member is in. |
| **Late** | They arrived after their expected start. |
| **Absent** | They are not in. |
| **On Leave** | They are away on booked leave. |
| **Not Marked** | Nothing recorded yet. |

Attendance reports summarise using **Present**, **Absent**, **Late**, **Leave**, **Excused** and **Not marked**.

### Active and inactive

The same pair appears in several places and always means the same thing: the record is either in use or retired without being deleted.

| Where | Labels |
|---|---|
| Children | **Active**, **Inactive** |
| Staff | **Active**, **Inactive**, with **Activate** and **Deactivate** to switch |
| Classes | **Active**, **Inactive** |
| Roles | **Active**, **Inactive** |
| Learn Area aspects | **Enabled** |
| My Center sessions | **Active**, **Not Active** |

Note the wording on **My Center** sessions is **Not Active** rather than **Inactive**.

### Daily report states

| Label | Meaning |
|---|---|
| **Published** | The report has been sent out and families can see it. |
| **Draft** | The report has been saved but not yet published. |
| **Pending** | Used in the summary counts for reports not yet published. |
| **Report not created** | No report exists for this child on this date. |

Within a report, a child's mood is one of **Great**, **Good**, **Okay**, **Unsettled** or **Upset**, and a temperature reads as **Normal** or **Elevated**.

### Calendar event types

Chosen when you add an event on **Calendar**.

**Holiday**, **Trip**, **Performance**, **Meeting**, **Class**, **Assessment**, **Reminder**, **Other**

An event's **Audience** is one of **All**, **Parents**, **Staff** or **Children**.

### Message types

Chosen on the **Messages** page: **Announcement**, **Notification**, **Event**, **Newsletter**, **Media**, **Video Media**.

### Service types

Set on a service record: **Services**, **Inventory**, **Tuition**, **Transport**, **Resources**, **Expense**.

### Referral and source types

Referral types: **Digital**, **Printed**, **Signs**, **Recommendation**, **Event**, **Others**.
Communication source groups: **General**, **Admission**, **Communication**.

### CRM lead stages

These are the stages a lead can hold, as shown on the **CRM Leads** page:

| Label | Meaning |
|---|---|
| **New Lead** | A fresh enquiry, not yet worked. |
| **KYC** | The know-your-customer step, where family details are gathered and checked. |
| **Book a Tour** | A visit is being arranged. |
| **Tour Taken** | The family has visited. |
| **Offer Letter** | An offer has been extended to the family. |
| **Admission** | The admission step. |
| **Accepted** | The family has accepted. |
| **Evaluation** | The child is being evaluated. |
| **Registered** | The child is registered. |
| **Lost** | The family did not proceed. |
| **Rejected** | The application was not taken forward. |

You may also see **Approved**, **Submitted** and a **MOVED TO STUDENT AFFAIRS** marker against a lead.

A lead's progress is also shown as four steps: **Info**, **Docs**, **Eval** and **Finance**.

#### One thing worth knowing about stage names

**The same underlying stage is labelled differently on the CRM Leads page and on the CRM tab of the Live Dashboard.** The clearest example is the second stage: the **CRM Leads** page calls it **KYC**, while the dashboard counts it as **Tour Booked**. Several other stages differ in the same way — the dashboard uses **New Leads**, **KYC**, **Tour Taken**, **Application**, **Evaluation**, **Approved**, **Registered** and **Total Lost**, which is not the same list as the Leads page.

**Treat the CRM Leads page as the one to trust.** It is where leads are actually worked and moved, and its labels are the ones to use when you talk to a colleague about where a family has got to. If a dashboard tile and the Leads page seem to disagree about how many families are at a given stage, the Leads page is the better answer.

### Currency

Amounts display in **AED** unless a different currency code is set on the center record. Currency is a property of the center, not something chosen per invoice or per receipt.

---

**How current is this?**

This describes the Peekaboo portal as at the current release. It covers what words mean and which statuses exist. It deliberately does not include step-by-step instructions for completing tasks — those are being verified separately and will follow.


---


<!-- ========== 10-children-and-staff ========== -->
...
<!-- ========== 20-attendance-and-daily-reports ========== -->
...
<!-- ========== 50-admissions-settings-and-access ========== -->
...
<!-- ========== 60-messages-calendar-dashboard ========== -->
...
Every system has a shape, and knowing where Peekaboo's edges are saves a lot of hunting for a button that was never there. Below is a plain list of things staff reasonably expect, which the portal does not do, each with the nearest thing that does work.

None of these are faults. They are simply the current shape of the product.

---

## Forms and requests

**There is no Forms module and no form builder.**
You cannot design your own form, publish it to parents or staff, or collect responses through the portal.
*Nearest thing:* for gathering information from families, the **Messages** page can send an **Announcement** or **Notification** carrying a **URL** and an **Attachment**, so a form hosted elsewhere can be shared that way.

**There is no staff requests feature.**
...
**There is no Incidents page.** You cannot log an accident or incident record.
*Nearest thing:* the **Daily Report** carries a temperature reading with a **Normal** or **Elevated** indication, plus **Activities & behaviour** and a **Note to parents**, which is where information about a child's day is recorded and shared.

**There is no Health page.** There is no place to manage medical records, allergies lists or health alerts as a page of their own.
*Nearest thing:* the **Children** page tracks how many children are **with allergies** and **with medical conditions**, an allergy indicator appears on the attendance board and in the daily report, and medical information lives on the individual child's record.

**There is no Schedule page.** There is no weekly timetable or shift planner.
*Nearest thing:* the **Calendar** page holds events, holidays and key dates by month, and **My Center** defines your center's daily sessions with a **From Time** and **To Time**.

**There is no Complaints page.** Complaints cannot be logged and tracked in the portal.
*Nearest thing:* there is no in-portal equivalent, so complaints need to be handled outside Peekaboo.

**There is no Classrooms page.** There is no separate page showing classroom occupancy and capacity.
*Nearest thing:* the **Classes** page under **Early Childhood** holds each classroom's age group, child count, teacher ratio and assigned teachers, and the **Main Dashboard** shows **Classroom Occupancy**.

**There is no Objectives page.** Objectives cannot be browsed or edited as their own list.
*Nearest thing:* objectives are selected against a child while recording an **Observation**, and each selected objective is given an attainment level there.

If somebody mentions one of these pages, they may have seen it in a demonstration or a different system. They are not part of what your center has.

---

## Invoices and receipts

**An invoice cannot be marked as paid.** There is no paid, unpaid or overdue status on an invoice, and no button to settle one.
*Nearest thing:* record the money in as a **Receipt**, then use **Balance by Class** to see each family's **Billed**, **Received** and **Balance**. The balance is what tells you whether a family has paid.

**Receipts are not linked to invoices.** A receipt is recorded against a child, not against a particular invoice, so you cannot see which invoice a payment settled or pull up a list of payments for one invoice.
*Nearest thing:* both sit against the child, so **Balance by Class** gives you the overall picture per family, and a receipt's **Description** and **Reference** are where a note about what the payment covers can be kept.

**There is no bulk invoicing.** You cannot raise invoices for a whole class or the whole nursery in one action. Each invoice is created for one child.

**There is no recurring or automatic invoicing.** Monthly fees do not raise themselves. Nothing generates an invoice on a schedule.
*Nearest thing:* the **Services** page keeps your fees and VAT rates set up in advance, so each invoice is quick to build from the price list.

**Currency is fixed.** Amounts show in the currency set on the center record, which is **AED** by default. You cannot bill one family in one currency and another in a different one, and there is no exchange rate handling.
*Nearest thing:* the **Currency Code** on the center record sets it for everything.

---

## Admissions

**A lead does not become a child record automatically.** Moving a lead all the way to **Registered** does not create a child in the **Children** page. There is no convert or enrol action that carries the details across.
...
**There are no read receipts.** You cannot tell whether a parent has opened or read something you sent.
*Nearest thing:* the **History** table records what was sent, whether it was **Published** and when, so you have a record of what went out even though you cannot see what was read.

**Parents cannot reply, and you cannot reply within a message.** Messages go one way, from the center out to families. There is no conversation thread.
*Nearest thing:* a message can carry contact details or a **URL** so families know how to respond by other means. Invoices, receipts and daily reports are emailed to the parent's own email address, so any reply arrives in your normal email.

**The chat panel is a demonstration.** The chat drawer you can open from the top of the screen shows sample conversations with placeholder names. It is not connected to your families and nothing typed into it reaches anybody.
*Nearest thing:* use the **Messages** page, which really does send.

---

## Automatic behaviour

**Nothing happens on its own.** Peekaboo does not run anything in the background. There is no overnight processing, no scheduled job, no automatic rollover from one day or month to the next.

**There are no notifications or alerts.** The portal does not notify you about anything — no badge for unread items, no alert when a fee falls overdue, no warning when a license is close to expiring.

**There are no reminders.** A **Task** against a CRM lead holds a **Set Reminder Date**, but the portal does not chase you on that date. The date is recorded for you to look at.

**Nothing is emailed automatically.** Emails go out when somebody chooses to send them — emailing an invoice or receipt to a parent, or using **Publish & Email** on a daily report. No email is triggered by a date or a status change on its own.

*Nearest thing for all of the above:* the **Live Dashboard** is the closest thing to an alert system. **Outstanding Fees**, **Pending Payments**, **Outstanding Balances** and **Days Late** surface what needs attention when you look at them, so the habit is to check the dashboard rather than wait to be told.

---

## Attendance

**Attendance is for today only.** The **Children Attendance** and **Staff Attendance** pages work on the current date. You cannot move them to another date to fill in a register you missed or to mark attendance in advance.
*Nearest thing:* **Attendance Reports** shows attendance history across any **From** and **To** date range for both children and staff, so looking back is well covered even though editing back is not.

---

## Other boundaries worth knowing

**There is no parent-facing login in this portal.** Peekaboo's portal is for center staff. Families receive information by email and through published daily reports rather than by signing in here.

**A child with related records cannot be deleted.** Once a child has history attached to them, removing the record is not possible.
*Nearest thing:* mark the child **Inactive** instead. They stop appearing in day-to-day use while their history stays intact.

**Role access is by page, not by record.** A role either can or cannot open a page. There is no setting that lets somebody see only their own class's children or only their own leads within a page they can open.

---

**How current is this?**

This describes the Peekaboo portal as at the current release. It covers what the portal does not do and what to use instead. It deliberately does not include step-by-step instructions for completing tasks — those are being verified separately and will follow.
